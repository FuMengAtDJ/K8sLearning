...
#### 5. ingress动作确认
   ...
   ```
    ...
    // 虚拟机外部https动作确认
    fumeng@fumengdeMacBook-Pro ~ % curl -H "Host: hellok8s.com" https://192.168.34.2:30236/bar -k
    Hello, Welcome to kubernetes.%
    fumeng@fumengdeMacBook-Pro ~ % curl -H "Host: hellok8s.com" https://192.168.34.2:30236/healthz -k
    200% 
   ```
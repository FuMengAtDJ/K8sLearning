...
#### 5.  动作确认 ingress
   ...
   ```
    ...
    // https动作确认
    // 此处我有一个很大的疑问，老师在上课时操作的是curl https://192.168.34.2:30236,返回的是nginx的404页面，老师说是正确的结果
    cadmin@k8snode:~/K8sLearning/httpserver/k8s/ingress$ curl -H "Host: hellok8s.com" https://10.0.2.15:30236 -k
    Hello, Welcome to kubernetes.
   ```